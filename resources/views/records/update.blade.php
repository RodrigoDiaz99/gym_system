                 ...
                 @can('editar')
                     <form action="{{ route('record.update', $record->id) }}" method="POST" enctype="multipart/form-data">
                         ...
                         <div aria-multiselectable="false" class="card-collapse" id="listaAcordion" role="tablist">
                             ...
                             <input type="text" id="users_id" name="users_id" value="{{ $record->users_id }}" readonly
                                 hidden>
                             <input type="text" id="numero_control" name="numero_control"
                                 value="{{ $record->numero_control }}" readonly hidden>
                             <hr>
                             {{-- identificacion --}}
                             <div class="border-bottom px-3">
                                                     ...
                                                     <div class="input-group">
                                                         <table class="table  text-center">
                                                             ...
                                                             <tbody>
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="herpes"
                                                                             id="herpes">
                                                                     </td>
                                                                 @endif
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="sifilis"
                                                                             id="sifilis">
                                                                     </td>
                                                                 @endif

                                                                 @if ($record->gonorrea)
                                                                     <td><input type="checkbox" name="gonorrea"
                                                                             id="gonorrea" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="gonorrea"
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="sida"
                                                                             id="sida">
                                                                     </td>
                                                                 @endif

                                                                 @if ($record->clamidia == 1)
                                                                     <td><input type="checkbox" name="clamidia"
                                                                             id="clamidia" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="clamidia"
                                                         ...
                                                         <table class="table  text-center">
                                                             ...
                                                             <tbody>
                                                                 @if ($record->desmayos == 1)
                                                                     <td><input type="checkbox" name="desmayos"
                                                                             id="desmayos" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="desmayos"
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="mareos"
                                                                             id="mareos">
                                                                     </td>
                                                                 @endif
                                                     ...
                                                     <div class="form-group mb-4">
                                                         <div class="input-group">
                                                             ...
                                                             <input class="form-control" autocomplete="off" type="date"
                                                                 ...
                                                                 value="{{ $record->fecha_hospitalizacion }}">
                                                         </div>
                                                     ...
                                                     <div class="input-group">
                                                         <table class="table  text-center">
                                                             ...
                                                             <tbody>
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="cesarea"
                                                                             id="cesarea">
                                                                     </td>
                                                                 @endif
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="abortos"
                                                                             id="abortos">
                                                                     </td>
                                                                 @endif

                                                                 @if ($record->apendice == 1)
                                                                     <td><input type="checkbox" name="apendice"
                                                                             id="apendice" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="apendice"
                                                                 ...
                                                                 @if ($record->vesicula == 1)
                                                                     <td><input type="checkbox" name="vesicula"
                                                                             id="vesicula" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="vesicula"
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="otro"
                                                                             id="otro">
                                                                     </td>
                                                                 @endif
                                                         ...
                                                         <div class="form-group mb-4">
                                                             <div class="input-group">
                                                                 <span class="input-group-text "><i
                                                                         class="ni ni-zoom-split-in"></i></span>
                                                                 <input class="form-control" autocomplete="off"
                                                                     type="text" name="causa_cirugia" id="causa_cirugia"
                                                                     value="{{ $record->causa_cirugia }}">
                                                             </div>
                                                 ...
                                                 <div class="col-md" id="especifique">
                                                     ...
                                                     <div class="form-group mb-4">
                                                         <div class="input-group">
                                                             <span class="input-group-text "><i
                                                                     class="ni ni-zoom-split-in"></i></span>
                                                             <textarea class="form-control" autocomplete="off" value="{{ $record->especifique_text }}" name="especifique_text"
                                                                 id="especifique_text">{{ $record->especifique_text }}</textarea>
                                                         </div>
                                                         ...
                                                         <table class="table  text-center">
                                                             ...
                                                             <tbody>
                                                                 @if ($record->alergias == 1)
                                                                     <td><input type="checkbox" name="alergias"
                                                                             id="alergias" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="alergias"
                                                                 ...
                                                                 @if ($record->cefaleas == 1)
                                                                     <td><input type="checkbox" name="cefaleas"
                                                                             id="cefaleas" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="cefaleas"
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="cancer"
                                                                             id="cancer">
                                                                     </td>
                                                                 @endif
                                                                 ...
                                                                 @if ($record->embarazos == 1)
                                                                     <td><input type="checkbox" name="embarazos"
                                                                             id="embarazos" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="embarazos"
                                                                             id="embarazos">
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="aborto"
                                                                             id="aborto">
                                                                     </td>
                                                                 @endif
                                     ...
                                     <div class="border-bottom px-3">
                                         ...
                                         <div class="modal-body">
                                             <div class="col-md">
                                                 ...
                                                 <div class="form-group">
                                                     <div class="input-group">
                                                         <textarea name="medicamentos" id="medicamentos" value="{{ $record->medicamentos }}"
                                                             placeholder="{{ $record->medicamentos }}" class="form-control" cols="30" rows="10"></textarea>
                                                     </div>
                                     ...
                                     <div class="col-md">
                                         ...
                                         <div class="form-group mb-4">
                                             <div class="input-group">
                                                 <span class="input-group-text "><i class="ni ni-zoom-split-in"></i></span>
                                                 <input class="form-control" autocomplete="off" type="text"
                                                     name="evacuaciones" id="evacuaciones"
                                                     value="{{ $record->evacuaciones }}">
                                             </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md">
                                         ...
                                         <div class="form-group mb-4">
                                             <div class="input-group">
                                                 <span class="input-group-text "><i class="ni ni-zoom-split-in"></i></span>
                                                 <input class="form-control" autocomplete="off" type="text"
                                                     name="micciones_dia" id="micciones_dia"
                                                     value="{{ $record->micciones_dia }}">
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-md">
                                         ...
                                         <div class="form-group mb-4">
                                             <div class="input-group">
                                                 <span class="input-group-text "><i class="ni ni-zoom-split-in"></i></span>
                                                 <input class="form-control" autocomplete="off" type="text"
                                                     name="micciones_noche" id="micciones_noche"
                                                     value="{{ $record->micciones_noche }}">
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                                         ...
                                                         <table class="table  text-center">
                                                             ...
                                                             <tbody>
                                                                 @if ($record->marihuana == 1)
                                                                     <td><input type="checkbox" name="marihuana"
                                                                             id="marihuana" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="marihuana"
                                                                             id="marihuana">
                                                                 ...
                                                                 @if ($record->opiaceos == 1)
                                                                     <td><input type="checkbox" name="opiaceos"
                                                                             id="opiaceos" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="opiaceos"
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="cocaina"
                                                                             id="cocaina">
                                                                     </td>
                                                                 @endif
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="heroina"
                                                                             id="heroina">
                                                                     </td>
                                                                 @endif

                                                                 @if ($record->pastillas == 1)
                                                                     <td><input type="checkbox" name="pastillas"
                                                                             id="pastillas" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="pastillas"
                                                                             id="pastillas">
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="crack"
                                                                             id="crack">
                                                                     </td>
                                                                 @endif
                                                                 ...
                                                                 @else
                                                                     <td><input type="checkbox" name="cristal"
                                                                             id="cristal">
                                                                     </td>
                                                                 @endif

                                                                 @if ($record->resistol == 1)
                                                                     <td><input type="checkbox" name="resistol"
                                                                             id="resistol" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="resistol"
                                                                 ...
                                                                 @if ($record->gasolina == 1)
                                                                     <td><input type="checkbox" name="gasolina"
                                                                             id="gasolina" checked>
                                                                     </td>
                                                                 @else
                                                                     <td><input type="checkbox" name="gasolina"
                             ...
                             <div class="collapse modal-body" id="collapseFoto" data-parent="#listaAcordion">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md">
                                         ...
                                         <div class="form-group mb-4">
                                             <div class="input-group">
                                                 <button type="button" class="btn btn-primary" value="open Camera"
                                                     onClick="open_Camera()">
                                                     Usar Camara
                                                 </button>
                                             </div>
