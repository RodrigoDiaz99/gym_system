<div class="modal fade" id="editProduct-unit-{{$productUnit->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="form-group mb-4">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control @error('unit_value') is-invalid @enderror" type="text"
                                        name="unit_value" value="{{ old('unit_value', $productUnit->value) }}"
                                        placeholder="Valor">
                                </div>
                                @error('unit_value')
                                    <strong class="text-danger">{{ $message }}</strong>
